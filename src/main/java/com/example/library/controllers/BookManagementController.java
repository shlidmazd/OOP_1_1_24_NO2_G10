...
//            btnUpdate.setVisible(true);
    ...
    public void onClickAdd(ActionEvent actionEvent) {
        ...
        if (!isValid("INTEGER_NUMBER", quantity)) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, "Quantity must be an integer!");
            return;
        }
        ...
        try {
            ...
            Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Information", null, "Add new book successfully!");
            tbBooks.setItems(bookService.getAllBook());
            clear();
    ...
    public void onClickDelete(ActionEvent actionEvent) {
        ...
        if (selectedBook.isPresent() && Alert.showConfirmation("Are you sure you want to delete?\nThis action cannot be undone!")) {
            bookService.deleteBook(selectedBook.get());
        } else if (selectedBook.isEmpty()) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, "Please select a book to delete!");
        }
        tbBooks.setItems(bookService.getAllBook());
    }
    ...
    public void onClickUpdate(ActionEvent actionEvent) {
        ...
        if (selectedBook.isPresent()) {
            ...
            tbBooks.setItems(bookService.getAllBook());
            Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Success", null, "Update book successfully!");
            clear();
        } else {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, "Please select a book to update!");
        }
...
//        btnUpdate.setVisible(false);
    ...
    public void onClickRequest(ActionEvent actionEvent) {
        ...
        if (selectedBook.getQuantity() == 0) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, "This book is out of stock!");
            return;
        }
        ...
        if (returnDate == null) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, "Please choose a return date!");
            return;
        ...
        Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Success", null, "Request borrow successfully!");
