...
//            btnUpdate.setVisible(true);
    ...
    public void onClickAdd(ActionEvent actionEvent) {
        ...
        if (!isValid("EMAIL", email)) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, "Invalid email!");
            return;
        }

        if (!isValid("PHONE_NUMBER", phoneNumber)) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, "Invalid phone number!");
            return;
        }
        ...
        try {
            ...
            clear();
            Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Information", null, "Add reader successfully!");
        } catch (Exception e) {
    ...
    public void onClickDelete(ActionEvent actionEvent) {
        ...
        if (selectedReader.isPresent() && Alert.showConfirmation("Are you sure you want to delete this reader?")) {
    ...
    public void onClickUpdate(ActionEvent actionEvent) {
        ...
        if (selectedReader.isEmpty()) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Lỗi", null, "Please select a reader to update");
            return;
        }
        ...
        try {
            ...
            Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Information", null, "Update reader successfully!");
            clear();
        } catch (Exception e) {
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "Error", null, e.getMessage());
            return;
