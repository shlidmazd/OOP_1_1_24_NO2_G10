...
public class RequestController implements Initializable {
    ...
    public void onClickApprove(ActionEvent actionEvent) {
        if(selectedBorrowId.isEmpty()){
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "No Request Selected", null,"Please select a request to approve");
            return;
        }
        ...
        setDataToTable();
        Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Request Approved", null,"Request Approved Successfully");
        selectedBorrowId.clear();
    }

    public void onClickReject(ActionEvent actionEvent) {
        if(selectedBorrowId.isEmpty()){
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "No Request Selected", null,"Please select a request to reject");
            return;
        }
        ...
        Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Request Declined", null,"Request Declined Successfully");
        selectedBorrowId.clear();
    }

    public void onClickDeleteRequest(ActionEvent actionEvent) {
        if(selectedBorrowId.isEmpty()){
            Alert.showAlert(javafx.scene.control.Alert.AlertType.ERROR, "No Request Selected", null,"Please select a request to delete");
            return;
        }

        if(!Alert.showConfirmation("Are you sure you want to delete this request?")){
            return;
        }
        ...
        Alert.showAlert(javafx.scene.control.Alert.AlertType.INFORMATION, "Request Deleted", null,"Request Deleted Successfully");
